public class CompileCheck {
  ...
  public static void main(String[] args) {
    ...
    SoccerResult soccerResultCheck = new SoccerResult(soccerTeamCheck, soccerTeamCheck, 10.5,15.2);
    LegoRobotResult robotsResultCheck = new LegoRobotResult(robotsTeamCheck, robotsTeamCheck, 3.1, 5, true, 3.2, 2, false);
